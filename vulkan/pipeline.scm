...
(define create-shader-stages
  (lambda (device vertex-shader-filename fragment-shader-filename)
	...
	(let ((info
	       (make-vk-shader-module-create-info shader-module-create-info
						  0 0
	...
	(make-vk-pipeline-shader-stage-create-info pipeline-shader-stage-create-info
						   0 0
						   shader-stage-bit
    ...
    (let ((vertex-spv (compile-shaders vertex-shader-filename
				       shaderc-vertex-shader))
	  (frag-spv (compile-shaders fragment-shader-filename
